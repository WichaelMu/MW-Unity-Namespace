...
<br>
<br>
The documentation is automatically generated. The source code for generation is separate from MW. The Documentation Generator can be found [here](https://github.com/WichaelMu/MW-Unity-Namespace/tree/main/MGenerator).
