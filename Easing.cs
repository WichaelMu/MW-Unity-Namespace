...
namespace MW.Easing {
    ...
    public static class Interpolate {
        ...
        public static Function GetEasingFunctionDerivative(EEquation equation) {
            if (equation == EEquation.EaseInQuad) {
                return EaseInQuadD;
            } else if (equation == EEquation.EaseOutQuad) {
                return EaseOutQuadD;
            } else if (equation == EEquation.EaseInOutQuad) {
                return EaseInOutQuadD;
            } else if (equation == EEquation.EaseInCubic) {
                return EaseInCubicD;
            } else if (equation == EEquation.EaseOutCubic) {
                return EaseOutCubicD;
            } else if (equation == EEquation.EaseInOutCubic) {
                return EaseInOutCubicD;
            } else if (equation == EEquation.EaseInQuart) {
                return EaseInQuartD;
            } else if (equation == EEquation.EaseOutQuart) {
                return EaseOutQuartD;
            } else if (equation == EEquation.EaseInOutQuart) {
                return EaseInOutQuartD;
            } else if (equation == EEquation.EaseInQuint) {
                return EaseInQuintD;
            } else if (equation == EEquation.EaseOutQuint) {
                return EaseOutQuintD;
            } else if (equation == EEquation.EaseInOutQuint) {
                return EaseInOutQuintD;
            } else if (equation == EEquation.EaseInSine) {
                return EaseInSineD;
            } else if (equation == EEquation.EaseOutSine) {
                return EaseOutSineD;
            } else if (equation == EEquation.EaseInOutSine) {
                return EaseInOutSineD;
            } else if (equation == EEquation.EaseInExpo) {
                return EaseInExpoD;
            } else if (equation == EEquation.EaseOutExpo) {
                return EaseOutExpoD;
            } else if (equation == EEquation.EaseInOutExpo) {
                return EaseInOutExpoD;
            } else if (equation == EEquation.EaseInCirc) {
                return EaseInCircD;
            } else if (equation == EEquation.EaseOutCirc) {
                return EaseOutCircD;
            } else if (equation == EEquation.EaseInOutCirc) {
                return EaseInOutCircD;
            } else if (equation == EEquation.Linear) {
                return LinearD;
            } else if (equation == EEquation.Spring) {
                return SpringD;
            } else if (equation == EEquation.EaseInBounce) {
                return EaseInBounceD;
            } else if (equation == EEquation.EaseOutBounce) {
                return EaseOutBounceD;
            } else if (equation == EEquation.EaseInOutBounce) {
                return EaseInOutBounceD;
            } else if (equation == EEquation.EaseInBack) {
                return EaseInBackD;
            } else if (equation == EEquation.EaseOutBack) {
                return EaseOutBackD;
            } else if (equation == EEquation.EaseInOutBack) {
                return EaseInOutBackD;
            } else if (equation == EEquation.EaseInElastic) {
                return EaseInElasticD;
            } else if (equation == EEquation.EaseOutElastic) {
                return EaseOutElasticD;
            } else if (equation == EEquation.EaseInOutElastic) {
        ...
        /// <summary>Interpolate using EEquation from fStart to fEnd in fDuration.</summary>
        /// <param name="EEquation">Equation to interpolate.</param>
        /// <param name="fStart">The value to start interpolating from.</param>
        /// <param name="fEnd">The value to interpolate towards.</param>
        /// <param name="fDuration">The time to interpolate from fStart to fEnd.</param>
        /// <example>How to call Ease <see cref="Ease(EEquation, float, float, float)"></see>. Linearlly interpolate from 0 to 10 in 5 seconds.
        /// <code>
        /// MW.EEquation equation = MW.Equation.Linear;
        /// float fStart = 0;
        /// float fEnd = 10;
        /// float fDuration = 5;
        /// 
        ...
        /// void Update() {
        ///     t += Time.deltaTime;
        ///     float fInterpolated = MW.Easing.Interpolate.Ease(equation, fStart, fEnd, t / fDuration);
        /// }
        /// </code>
        /// </example>
